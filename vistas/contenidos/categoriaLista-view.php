      ...
      <div class="contenedor-formularios mb-2">
          ...
          <div class="full-box page-header">
            ...
            <p class="text-justify">
                Lista de noticias ordenadas por orden alfabético.
            </p>
          </div>
          ...
          <div class="container-fluid">
            <ul class="listado-panel">
              <li>
                  <a href="<?php echo SERVERURL; ?>categoriaLista/" class="enlace-lista activo1">
                  ...
                  <div class="container-fluid">
                    <div class="panel panel-info shadow">
                      <div class="panel-heading">
                        <h3 class="panel-title"><i class="fas fa-list"></i> &nbsp; LISTA DE CATEGORÍAS</h3>
                      </div>
                      <div class="panel-body">
                      <?php 
                          $pagina = explode("/", $_GET['views']);
                          echo $inscategoria->paginador_categoria_controlador($pagina[1],12,$_SESSION['privilegio_unprg'],"");
                      ?>
                      </div>
                    </div>
                  </div>
