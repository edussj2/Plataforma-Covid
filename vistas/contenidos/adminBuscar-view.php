    ...
    <div class="row mb-5">
      <div class="contenedor-formularios mb-2">
        ...
        <div class="full-box page-header">
            ...
            Búsqueda de administadores por número de DNI, Nombres y Apellidos. Se mostrará las mejores coincidencias en una lista con opciones, según el privilegio de la cuenta.
            </p>
        </div>
        ...
        <div class="container-fluid">
          <ul class="listado-panel">
              ...
              <li>
                  <a href="<?php echo SERVERURL; ?>adminNuevo/" class="enlace-nuevo">
                    <i class="fas fa-plus"></i> &nbsp; AGREGAR
                  </a>
              </li>      
              <li>
                  <a href="<?php echo SERVERURL; ?>adminBuscar/" class="enlace-buscar activo3">
...
<?php 
  if(!isset($_SESSION['busqueda_administrador']) && empty($_SESSION['busqueda_administrador'])):
?>
              ...
              <div class="form-row align-items-center justify-content-center">
                <div class="col-sm-7 my-1">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Datos para buscar" name="busqueda_administrador" required="">
                  </div>
                </div>
...
<?php else: ?>
        ...
        <div class="container pt-5 pb-5 shadow mb-5" style="width: 92%;">
          <form action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" method="POST" data-form="default" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data">
            <p class="lead text-center">Su última búsqueda  fue <strong>“<?php echo $_SESSION['busqueda_administrador'];?>”</strong></p>
            <div class="row">
                <input class="form-control" type="hidden" name="eliminar_busqueda_administrador" value="1">
                <div class="col-12">
                    <p class="text-center">
                ...
                <div class="container-fluid">
                  <div class="panel panel-lista shadow">
                    ...
                    <?php
                      ...
                      echo $insAdministrador->paginador_administrador_controlador($pagina[1],15,$_SESSION['privilegio_unprg'],$_SESSION['codigo_cuenta_unprg'],$_SESSION['busqueda_administrador']);
                    ?>
                    </div>
                  </div>
                </div>
