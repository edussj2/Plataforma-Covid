        ...
        <!-- Page header -->
                ...
                <div class="container-fluid">
                    <ul class="listado-panel">
                        <li>
                            <a href="<?php echo SERVERURL; ?>consejoLista/" class="enlace-lista">
                            <i class="far fa-list-alt"></i> &nbsp; LISTADO
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL; ?>consejoNuevo/" class="enlace-nuevo activo2">
                              ...
                              <div class="container-fluid">
                                <div class="panel panel-agregar shadow">
                                  <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fas fa-plus"></i>&nbsp; NUEVA CONSEJO</h3>
                                  </div>
                                  <div class="panel-body">
                                    <form class="needs-validation FormularioAjax" novalidate data-form="save" action="<?php echo SERVERURL; ?>ajax/consejoAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                <div class="form-group">
                                                  <label>Tema</label>
                                                  <select name="tema-reg" class="form-control" required="">
                                                  <option value="-1">Seleccione un tema</option>
                                                      <?php 
                                                        ...
                                                        $tema = $instema->datos_tema_controlador("Select",0);
                                                        while ($rowD = $tema->fetch()) {
                                                          echo '<option value="'.$rowD['idTema'].'">'.$rowD['TemaTitulo'].'</option>';
                                                        }
                                                      ?>
                                                  </select>
                                              ...
                                              <div class="col-lg-6">
                                                <div class="form-group">
                                                  <label>Titulo *</label>
                                                  <input class="form-control" type="text" name="titulo-reg" required="" maxlength="200">
                                                  <div class="invalid-feedback">
                                                   Complete el campo correctamente.
                                                  </div>
                                                </div>
                                              ...
                                              <div class="col-12">
                                                <div class="form-group">
                                                  ...
                                                  <textarea name="consejo-reg" class="form-control" rows="3" required=""></textarea>
                                                </div>
                                              </div>
