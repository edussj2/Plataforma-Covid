    ...
    <div class="row mb-5">
      <div class="contenedor-formularios mb-2">
        ...
        <div class="full-box page-header">
          ...
          Lista de administradores ordenados por orden de registro de forma descendente, con sus respectivas opciones, según el privilegio de la cuenta.
          </p>
        </div>
        ...
        <div class="container-fluid">
          <ul class="listado-panel">
            <li>
              <a href="<?php echo SERVERURL; ?>adminLista/" class="enlace-lista activo1">
                  ...
                  <div class="panel panel-info shadow">
                    ...
                    <div class="panel-body">
                      <?php 
                          ...
                          echo $insAdministrador->paginador_administrador_controlador($pagina[1],10,$_SESSION['privilegio_unprg'],$_SESSION['codigo_cuenta_unprg'],"");
                      ?>
                    </div>
                  </div>
                </div>
