    ...
    <div class="row mb-5">
      <div class="contenedor-formularios mb-2">
          ...
          <div class="full-box page-header">
            ...
            Lista de especialistas ordenados por orden de registro de forma descendente, con sus respectivas opciones, según el privilegio de la cuenta.
            </p>
          </div>
          ...
          <div class="container-fluid">
              <ul class="listado-panel">
                  <li>
                      <a href="<?php echo SERVERURL; ?>especialistaLista/" class="enlace-lista activo1">
                      <i class="far fa-list-alt"></i> &nbsp; LISTADO
                      </a>
                  </li>
                  <li>
                      <a href="<?php echo SERVERURL; ?>especialistaNuevo/" class="enlace-nuevo">
