        ...
        <section class="pb-4">   
          ...
          <div class="container-fluid">
            <ul class="listado-panel">
                <li>
                    <a href="<?php echo SERVERURL; ?>temaLista/" class="enlace-lista activo1">
                      <i class="far fa-list-alt"></i> &nbsp; LISTADO
                    </a>
                </li>
                <li>
                    <a href="<?php echo SERVERURL; ?>temaNuevo/" class="enlace-nuevo">
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-info shadow">
                                      <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fas fa-list"></i> &nbsp; LISTA DE TEMAS</h3>
                                      </div>
                                      <div class="panel-body">
                                      <?php 
                                          $pagina = explode("/", $_GET['views']);
                                          echo $instema->paginador_tema_controlador($pagina[1],10,$_SESSION['privilegio_unprg'],"");
                                      ?>
                                      </div>
                                    </div>
                                </div>
