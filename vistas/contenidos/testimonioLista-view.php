              ...
              <div class="row mb-5">
                ...
                <div class="full-box page-header">
                    ...
                    <p class="text-justify">
                        Lista de los testimonios emitidos por usuarios que han tratado con el especialista.
                    </p>
                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-info shadow">
                                      ...
                                      <?php 
                                          ...
                                          echo $instestimonio->paginador_testimonio_controlador($pagina[1],10,$_SESSION['privilegio_unprg'],"");
                                      ?>
                                      </div>
                                    </div>
                                </div>
